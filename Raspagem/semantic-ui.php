...
<head>
    ...
    <title>Raspagem: Semantic UI</title>
        ...
        <div class="ui grid">
            ...
            <?php
                ...
                <table class="ui table">
                    <thead>
                        <tr>
                            <th colspan="3" class="ui center aligned text-uppercase">Balneário Camboriú - '.$global_ano.'</th>
                        </tr>
                        <tr>
                            <th class="ui center aligned text-uppercase">Balneário</th>
                            <th class="ui center aligned text-uppercase">Ponto de Coleta</th>
                            <th class="ui center aligned text-uppercase">Localização</th>
                        </tr>
                    </thead>
                    <tbody>';
                    ...
                    $dez_pie = '';
                        ...
                        foreach($beaches as $beach){
                            echo'
                            <tr class="tr-info">
                                <td class="ui center aligned text-uppercase">'.$beach->descricao->Balneário.'</td>
                                <td class="ui center aligned text-uppercase">'.$beach->descricao->Ponto_de_Coleta.'</td>
                                <td class="ui center aligned text-uppercase">'.$beach->descricao->Localização.'</td>
                            </tr>';
