...
<head>
    ...
    <title>Raspagem Bootstrap</title>
            ...
            <?php
                ...
                <table class="table table-bordered">
                    <thead class="thead-dark">
                        <tr>
                            <th colspan="3" class="text-center text-uppercase">Balneário Camboriú - '.$global_ano.'</th>
                        </tr>
                        <tr>
                            <th class="text-center text-uppercase">Balneário</th>
                            <th class="text-center text-uppercase">Ponto de Coleta</th>
                            <th class="text-center text-uppercase">Localização</th>
                        </tr>
                    </thead>
                    <tbody>';
                    ...
                    $dez_pie = '';
                        ...
                        foreach($beaches as $beach){
                            echo'
                            <tr class="table-info">
                                <td class="text-center text-uppercase">'.$beach->descricao->Balneário.'</td>
                                <td class="text-center text-uppercase">'.$beach->descricao->Ponto_de_Coleta.'</td>
                                <td class="text-center text-uppercase">'.$beach->descricao->Localização.'</td>
                            </tr>';
